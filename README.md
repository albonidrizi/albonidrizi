...
Currently, I work as a **Java Developer**, where I build secure microservices, design RESTful applications, and integrate complex systems such as OAuth2, PayPal, and OpenAI.  
...
- 🤖 Real-time interview assistance using OpenAI GPT-4o  
- ☁️ Full-stack deployment (Heroku + Netlify)
...
🧠 **Tech Stack**  
`Java` · `Spring Boot` · `Spring Security` · `OAuth2` · `REST API`  
`Thymeleaf` · `MySQL/PostgreSQL` · `PayPal SDK` · `OpenAI GPT-4o`  
`CI/CD` · `GitHub Actions` · `Jenkins` · `HTML/CSS/JavaScript` · `Maven`
